...
graph TD
    ...
    C --> C1["POST /api/auth/register<br/>Body: username, password<br/>Returns: token, playerId"]
    C1 -->|201 Created| I
    C1 -->|409 Username Exists| C
    
    D --> D1["POST /api/auth/login<br/>Body: username, password<br/>Returns: token, playerId"]
    D1 -->|200 OK| I
    ...
    J -->|Logout| M["POST /api/auth/logout<br/>Clear JWT token"]
    ...
    K --> K1["POST /api/game/start<br/>Headers: Authorization Bearer token<br/>Returns: sessionId, energy: 50, score: 0"]
...
### 4. Data Architecture
```csharp
public class VRGameSession {
    public int sessionId;
    public int wisdomEnergy = 50;
    public int score = 0; 
    public List<TrialResult> trials = new();
    public VRMetrics vrMetrics = new();
    public DateTime startTime;
}

public class VRMetrics {
    public string headsetModel;
    public string[] controllers;
    public Vector3[] headPositions;
    public float averageFrameRate;
    public int totalHandGestures;
}
```
